...
from mall_app.users.views import RegisterUserView, LoginUserView, LogoutUserView, index, UserProfileView, \
    UserProfileDeleteView, increase_item_quantity, CustomPasswordResetConfirmView
...
urlpatterns = (
    ...
    path('reset/<uidb64>/<token>/', CustomPasswordResetConfirmView.as_view(template_name='user_templates/password_reset_confirm.html'), name='password_reset_confirm'),
